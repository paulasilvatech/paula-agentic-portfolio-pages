...
(function(){
  ...
  const chromeText = `Paula Silva | Software Global Black Belt · ${D.topicLabel}`;
  ...
  function fmtHTML(f){
    return `<a href="${f.href}" class="fmt" data-accent="${f.accent||D.accent}">
    ...
    <div class="container">
      <div class="hero__grid">
        <div>
          ...
          <div class="hero__cta">
            ${D.existingDeck ? `<a href="${D.existingDeck}" class="btn btn--primary">${tri({en:'Open the deck','pt-br':'Abrir o deck',es:'Abrir el deck'})} <svg viewBox="0 0 24 24"><path d="M5 12h14M13 5l7 7-7 7"/></svg></a>` : ''}
            <a href="${D.existingPlaybook || 'playbook.html'}" class="btn btn--ghost">${tri({en:'Read the playbook','pt-br':'Ler o playbook',es:'Leer el playbook'})}</a>
          </div>
        </div>
  ...
  <section class="section section--alt" id="formats"><div class="container">
    ...
    <h2 class="section__title">${tri({en:'Three formats, one thesis.','pt-br':'Três formatos, uma tese.',es:'Tres formatos, una tesis.'})}</h2>
  ...
  <section class="closing">
    <div class="closing__container">
      ...
      <div class="closing__cta">
        ...
        <a href="${D.existingPlaybook || 'playbook.html'}" class="closing__btn">
          ...
          <div class="closing__btn-label">${tri({en:'Continue with','pt-br':'Continuar com',es:'Continuar con'})}<span class="closing__btn-value">${tri({en:'The playbook','pt-br':'O playbook',es:'El playbook'})}</span></div>
        </a>
